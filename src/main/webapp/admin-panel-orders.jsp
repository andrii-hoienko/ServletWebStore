    ...
    <div class="advantages-container">
        <table>
            <tr>
                ...
                <th><fmt:message key="orders.product"/></th>
            ...
            <c:forEach items="${requestScope.orders}" var="order">
                <form action="${pageContext.request.contextPath}/admin-panel/orders-change" method="post">
                    <tr>
                        <td>${order.getId()}</td>
                ...
                <c:forEach items="${order.getProductMap().entrySet()}" var="product">
                    <tr>
                        <td></td>
