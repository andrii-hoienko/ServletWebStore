...
<main>
    <div class="advantages-container">
        ...
        <form action = "${pageContext.request.contextPath}/login-post" method="post">

            <p>
                <input type="text" id="email" name="email" class="feedback-input" placeholder="<fmt:message key="login.email"/>" id = "email">
            </p>
