...
<%@ page import="com.example.webstore.model.Cart" %>
...
<header>
    <div class="logo">
        <a href="${pageContext.request.contextPath}/main"><i class="material-icons" id="graphiclogo">store</i></a>
...
<a href="${pageContext.request.contextPath}/admin-panel"><fmt:message key="admin.panel"/></a>            </c:if>
...
<main>
    <div class="advantages-container">
        <c:if test="${sessionScope.cart.getProducts().size() != 0 && !requestScope.accessDenied}">
            <table>
                <tr>
                ...
                <tr>
                    ...
                    <th>
                        <form action="${pageContext.request.contextPath}/cart-post" method="post">
        ...
        <c:if test="${sessionScope.cart.getProducts().size() == 0 && requestScope.isOrderDone == null}">
